...
void solve() {
    ...
    ll intersection = 0;
    intersection += 1LL * max(0, min(a.x2, b.x2) - max(a.x1, b.x1)) * max(0, min(a.y2, b.y2) - max(a.y1, b.y1));
    intersection += 1LL * max(0, min(a.x2, c.x2) - max(a.x1, c.x1)) * max(0, min(a.y2, c.y2) - max(a.y1, c.y1));

    ll area = a.area() - intersection + (1LL * max(0, min(a.x2, b.x2, c.x2) - max(a.x1, b.x1, c.x1)) * max(0, min(a.y2, b.y2, c.y2) - max(a.y1, b.y1, c.y1)));
    if (area > 0) yes();
    else no();
}
