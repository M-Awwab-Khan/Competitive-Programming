...
void solve() {
    ...
    // Count negative numbers and find sum of absolute values
    ll neg_count = 0;
    ll sum = 0;
    ...
    // If negative count is even, all can be made positive
    // If odd, we need to flip the smallest absolute value
    if (neg_count % 2 == 0) {
        print(sum);
    } else {
        print(sum - 2 * min_abs);
