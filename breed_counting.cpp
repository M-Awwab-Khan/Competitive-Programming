...
int main() {
    ...
    vi holstein(n+1, 0), guernsey(n+1, 0), jersey(n+1, 0);
    cf(i, 1, n) {
        ...
        int breed;
        cin >> breed;
        if (breed == 1) holstein[i]++;
        else if (breed == 2) guernsey[i]++;
        else jersey[i]++;
    }
    ...
    fnr(i, q) {
        ll a, b;
        cin >> a >> b;
        cout << holstein[b] - holstein[a-1] << " " << guernsey[b] - guernsey[a-1] << " " << jersey[b] - jersey[a-1] << endl;
    }
    return 0;
}
