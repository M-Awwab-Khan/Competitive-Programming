...
void solve() {
    int n; cin >> n;
    umap<string, int> mp {{"Bessie", 0}, {"Elsie", 0}, {"Daisy", 0}, {"Gertie", 0}, {"Annabelle", 0}, {"Maggie", 0}, {"Henrietta", 0}};
    ...
    int secondMinMilk = mp[ans];

    int cnt = 0;
    rep(i, 0, y.size()) {
      if (y[i].ff == secondMinMilk) ++cnt;
    }
    if (cnt > 1) {
        print("Tie");
    } else {
