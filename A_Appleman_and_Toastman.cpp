...
int main() {
    ...
    // appleman gives n numbers to toastman, toastman adds their sum to the score
    // then retuns the group, appleman splits the group and gives back, toastman does the same.
    // splitting in a way which maximizes the score.
    // one possible way is to sort then split leaving the smallest element each time.
    // Let's try
