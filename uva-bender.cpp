...
int main() {
    ...
    while(cin >> L) {
        ...
        fnr(i, L-1) {
            ...
            if (pointing == "+x") {
                if (command == "+y") pointing = "+y";
                else if (command == "-y") pointing = "-y";
                else if (command == "+z") pointing = "+z";
                else if (command == "-z") pointing = "-z";
            } else if (pointing == "-x") {
                if (command == "+y") pointing = "-y";
                else if (command == "-y") pointing = "+y";
                ...
                if (command == "+y") pointing = "-x";
                else if (command == "-y") pointing = "+x";
            } else if (pointing == "-y") {
                if (command == "+y") pointing = "+x";
                else if (command == "-y") pointing = "-x";
            } else if (pointing == "+z") {
                if (command == "+z") pointing = "-x";
                else if (command == "-z") pointing = "+x";
            } else if (pointing == "-z") {
                if (command == "+z") pointing = "+x";
                else if (command == "-z") pointing = "-x";
            }
