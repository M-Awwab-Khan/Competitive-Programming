...
void solve() {
    ...
    // overlap with billboard 1
    // x -overlap
    int x_overlap1 = max(min(x12, a2) - max(x11, a1), 0);
    // debug(x_overlap1);

    int overlap = max(min(y12, b2) - max(y11, b1), 0) * x_overlap1;
    // debug(overlap);
    // overlap with billboard 2
    // x -overlap
    int x_overlap2 = max(min(x22, a2) - max(x21, a1), 0);
    // debug(x_overlap2);

    overlap += max(min(y22, b2) - max(y21, b1), 0) * x_overlap2;
    // debug(overlap);

    int area1 = (x12 - x11) * (y12 - y11);
    int area2 = (x22 - x21) * (y22 - y21);
