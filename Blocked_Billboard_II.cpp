...
void solve() {
    ...
    if (width * height == 0) print(a.area());
    else if (width == a.width && height == a.height) print(0);
    else if (width == a.width) {
        int touchpoints = 2;
        touchpoints += (b.y1 <= a.y1 || (b.y1 > a.y1 && b.y2 >= a.y2));
        if (touchpoints == 3) print((a.height - height) * width);
        else print(a.area());
    }
    else if (height == a.height) {
        int touchpoints = 2;
        touchpoints += (b.x1 <= a.x1 || (b.x1 > a.x1 && b.x2 >= a.x2));
        if (touchpoints == 3) print((a.width - width) * height);
        else print(a.area());
    }
    else print(a.area());
