...
#define ordered_set tree<int, null_type,less<int>, rb_tree_tag,tree_order_statistics_node_udate>
...
string to_uper(string a) { for (int i=0;i<(int)a.size();++i) if (a[i]>='a' && a[i]<='z') a[i]-='a'-'A'; return a; }
